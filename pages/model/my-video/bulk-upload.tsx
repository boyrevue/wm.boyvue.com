...
class BulkUploadVideo extends PureComponent {
  ...
  render() {
    ...
    return (
      <Layout>
        <PageTitle title="Bulk Upload Video" />
        <div className="main-container-900">
          ...
          >
            ...
            <div className="button-bottom-form">
              <Button type="primary" size="large" htmlType="submit" loading={uploading} disabled={uploading || !fileList.length}>
                Upload all
              </Button>
            </div>
          </Form>
