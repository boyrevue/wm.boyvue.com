  ...
  render() {
    ...
    return (
      <div className={style['prd-card']}>
        ...
        <div
          style={{ cursor: (!user?._id || (user?.isPerformer && product?.performer?._id !== user?._id)) ? 'not-allowed' : 'pointer', backgroundImage: `url('${thumbUrl}')` }}
          aria-hidden
          ...
          onClick={() => {
            ...
            Router.push(
              ...
              `/${product?.performer?.username}/store/${product?.slug || product?._id}`
            );
          }}
        >
