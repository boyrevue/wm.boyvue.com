...
export class FeedService extends APIRequest {
  ...
  pinToProfile(id: string) {
    return this.post(`/feeds/performers/pin-to-profile/${id}`);
  }

  unPinToProfile(id: string) {
    return this.post(`/feeds/performers/unpin-to-profile/${id}`);
  }
}
