...
export class PhotoService extends APIRequest {
  ...
  update(id: string, payload: any) {
    return this.put(`/performer/performer-assets/photos/${encodeURIComponent(id)}`, payload);
  }

  setCoverGallery(id: string) {
    return this.post(`/performer/performer-assets/photos/set-cover/${encodeURIComponent(id)}`);
  }
